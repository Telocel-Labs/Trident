...
-- Dead-letter table for well-formed events whose insert into soroban_events
-- repeatedly failed after bounded retries (issue #208). Distinct from
-- parse_errors above, which holds events that never decoded at all.
-- ---------------------------------------------------------------------------
